		...
		CKEDITOR.dialog.add( 'MediaEmbedDialog', function (instance){
			return {
				...
				onOk: function() {
					...
					p.setHtml(this.getContentElement('iframe', 'embedArea').getValue());
					instance.insertElement(p);
				}
			};
		});

		editor.addCommand( 'MediaEmbed', new CKEDITOR.dialogCommand( 'MediaEmbedDialog', {allowedContent: 'iframe[*]'} ));
